...
require_once dirname(__DIR__, 2) . "/api/models/connection.php";
require_once "curl.controller.php";
require_once dirname(__DIR__, 2) . "/api/models/turnstile.model.php";
...
class InstallController{
        ...
        static public function connect(){
                ...
                try{
                        ...
                        $info = InstallController::infoDatabase();
